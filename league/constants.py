...
HIRELINGS = [
    (HIRELINGS_BADGERS_P, _("Vault Keepers (P)")),
    (HIRELINGS_BADGERS_D, _("Badger Bodyguards (D)")),
    (HIRELINGS_BAND_P, _("Popular Band (P)")),
    (HIRELINGS_BAND_D, _("Street Band (D)")),
    (HIRELINGS_BANDITS_P, _("Highway Bandits (P)")),
    (HIRELINGS_BANDITS_D, _("Bandit Gangs (D)")),
    (HIRELINGS_CROWS_P, _("Corvid Spies (P)")),
    (HIRELINGS_CROWS_D, _("Raven Sentries (D)")),
    (HIRELINGS_LIZARDS_P, _("Warm Sun Prophets (P)")),
    (HIRELINGS_LIZARDS_D, _("Lizard Envoys (D)")),
    (HIRELINGS_MOLES_P, _("Sunward Expedition (P)")),
    (HIRELINGS_MOLES_D, _("Mole Artisans (D)")),
    (HIRELINGS_BIRDS_P, _("Last Dynasty (P)")),
    (HIRELINGS_BIRDS_D, _("Bluebird Nobles (D)")),
    (HIRELINGS_CATS_P, _("Forest Patrol (P)")),
    (HIRELINGS_CATS_D, _("Feline Physicians (D)")),
    (HIRELINGS_PROTECTOR_P, _("Furious Protector (P)")),
    (HIRELINGS_PROTECTOR_D, _("Stoic Protector (D)")),
    (HIRELINGS_RATS_P, _("Flame Bearers (P)")),
    (HIRELINGS_RATS_D, _("Rat Smugglers (D)")),
    (HIRELINGS_OTTERS_P, _("Riverfolk Flotilla (P)")),
    (HIRELINGS_OTTERS_D, _("Otter Divers (D)")),
    (HIRELINGS_VAGABOND_P, _("The Exile (P)")),
    (HIRELINGS_VAGABOND_D, _("The Brigand (D)")),
    (HIRELINGS_ALLIANCE_P, _("Spring Uprising (P)")),
    (HIRELINGS_ALLIANCE_D, _("Rabbit Scouts (D)")),
]
HIRELINGS_NUMBER = 3